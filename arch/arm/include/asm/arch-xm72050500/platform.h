...
#define MISC_CTRL62         0x80F8
#define MISC_CTRL63         0x80FC
#define MISC_CTRL64         0x8100
#define MISC_CTRL65         0x8104
#define MISC_CTRL66         0x8108
 ...
 *  timestamp & stopwatch
 * ---------------------------------------------------------------------*/
#define STOPWATCH_CTRL_REG             (SYS_CTRL_REG_BASE + MISC_CTRL62)
...
#define TIMESTAMP_STOPWATCH_POINT_MAX  5
#define TIMESTAMP_ITEM_SIZE            16
#define TIMESTAMP_MAX_ITEM_CNT         200
#define TIMESTAMP_TIMER_BUS_CLK        50000000
#define TIMESTAMP_TIMER_DIV            256
#define TIMESTAMP_TIMER_BASE           TIMER2_REG_BASE
