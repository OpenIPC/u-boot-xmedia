...
{
	writel(0x5a5a5a5a, 0x40000000);
	if (0x5a5a5a5a != readl(0x40000000))
		goto end;
	writel(0x5a5a5a5a, 0x40000004);
	if (0x5a5a5a5a != readl(0x40000004))
		goto end;
	writel(0x5a5a5a5a, 0x40000008);
	if (0x5a5a5a5a != readl(0x40000008))
		goto end;
	writel(0x5a5a5a5a, 0x4000000c);
	if (0x5a5a5a5a != readl(0x4000000c))
		goto end;

	writel(0xa5a5a5a5, 0x40000000);
	if (0xa5a5a5a5 != readl(0x40000000))
		goto end;
	writel(0xa5a5a5a5, 0x40000004);
	if (0xa5a5a5a5 != readl(0x40000004))
		goto end;
	writel(0xa5a5a5a5, 0x40000008);
	if (0xa5a5a5a5 != readl(0x40000008))
		goto end;
	writel(0xa5a5a5a5, 0x4000000c);
	if (0xa5a5a5a5 != readl(0x4000000c))
		goto end;
	return 0;
end:
	return 1;
...
static void config_ddrc_long(void)
{
	writel(0x00000000, 0x120dc004);
	writel(0x00000000, 0x120dc008);
	if (check_ddr() == 0)
		return;

	writel(0x00000000, 0x120dc004);
	writel(0x00000011, 0x120dc008);
	if (check_ddr() == 0)
		return;

	writel(0x00000000, 0x120dc004);
	writel(0x00000022, 0x120dc008);
	if (check_ddr() == 0)
		return;

	writel(0x00000000, 0x120dc004);
	writel(0x00000033, 0x120dc008);
	if (check_ddr() == 0)
		return;

	writel(0x00000000, 0x120dc004);
	writel(0x00000044, 0x120dc008);
	if (check_ddr() == 0)
		return;

	writel(0x00000000, 0x120dc004);
	writel(0x00000055, 0x120dc008);
	if (check_ddr() == 0)
		return;

	writel(0x00000000, 0x120dc004);
	writel(0x00000066, 0x120dc008);
	if (check_ddr() == 0)
		return;

	writel(0x00000000, 0x120dc004);
	writel(0x00000077, 0x120dc008);
	if (check_ddr() == 0)
		return;

	writel(0x0000000a, 0x120dc004);
	writel(0x00000000, 0x120dc008);
	if (check_ddr() == 0)
		return;
